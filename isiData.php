...
<body>
    ...
    <section class="section-details-content">
        <main class="container m-4 pt-3">
            ...
            <div class="card">
                <div class=" w-75 pt-3 ps-3 ">
                    <label for="start">Tanggal :</label>
                    <input type="date" class="form-control" id="start" name="trip-start" value="2021-04-30" min="2000-01-01" max="2022-01-01">
                </div>
                ...
                <div class="pt-3 w-75 ps-3">
                    <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                    <label class="form-check-label" for="flexCheckDefault">
                        Tukar Point
                    </label>
                </div>
                <div class="row justify-content-start pt-4 mt-3 ps-3">
                    <div class="col-4">
                        Harga
                    </div>
                    <div class="col-4">
                ...
                <div class="row mt-4 ms-2">
                    <div class="col align-self-start mb-4">
                        <a href="#" class="btn btn-primary px-4 ">Check Out</a>
                    </div>
                </div>
            </div>
    </section>
