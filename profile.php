                ...
                <div class="col">
                    <div class="card card-details">
                        <div class="brand " style="text-align: center;">
                            <img src="assets/gambar_film/userr-01.png" style="width: 250px;height:350px;" alt="logo">
                        </div>
                        <div class="mb-1 col align-self-center text-center">
                            <label class="text-warning" for="Name">1.000 points</label>
                        </div>
                        <div class="mb-3 col align-self-center text-center">
                            <label for="formFileMultiple" class="form-label">Edit Foto</label>
                            <input class="form-control" type="file" id="inputGroupFile04">
                        </div>
                        <div class="form-group col-6 align-self-center mb-3">
                        ...
                        <div class="form-group align-self-center pt-4">
                            <a href="#" class="btn btn-primary px-3 ">Edit Profile</a>
                        </div>
